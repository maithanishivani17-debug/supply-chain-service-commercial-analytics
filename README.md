...
- Monthly late-delivery rates remained broadly between **53.53% and 60.28%**, suggesting that the issue was persistent rather than limited to a single period.

## **Market Performance**

Europe and Pacific Asia are the key areas requiring management attention because both combine above-baseline late delivery with significant commercial exposure.
...
The framework ensures that management priorities are based on **business impact rather than late-delivery percentage alone**.
...
- **Python / Jupyter** – Data preparation, quality validation and analytical workflow
